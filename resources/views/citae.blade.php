                                ...
                                <div class="card-stats">
                                    ...
                                    <div class="card-stats-items text-primary">
                                        <div class="card-stats-item">
                                            <div class="card-stats-item-count">{{auth()->user()->pendiente}}</div>
                                        ...
                                        <div class="card-stats-item">
                                            <div class="card-stats-item-count">{{auth()->user()->cumplido}}</div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="">
                                  <form method="post" action="{{route('citae.create')}}" class="needs-validation"
                                      novalidate="">
                                      @csrf
                                      <div class="card-body">
                                          <div class="row">
                                            <div class="form-group col-md-4 col-12" hidden>
                                ...
                                <div class="">
                                  ...
                                  @endif
                                    <form method="post" action="{{ route('citae.store') }}" class="needs-validation"
                                        novalidate="">
                                        @csrf
                                        <div class="card-body">
                                            <div class="row">
                                    ...
                                    <div class="table-responsive table-invoice">
                                        <table class="table table-striped" id="myTable1">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                <form action="{{ route('citae.destroy', $citasssps->id ) }}" method="POST">
                                                    @csrf
                                                    @method('DELETE')
