            ...
            <div class="main-content">
                <section class="section">
                    <div class="row">
                                ...
                                <div class="card-stats">
                                    ...
                                    <div class="card-stats-items text-primary">
                                        ...
                                        <div class="card-stats-item">
                                            ...
                                            <div class="card-stats-item-label">Cumplidas</div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="card card-statistic-2">
                                <div class="card-body text-justify font-weight-bold text-light">
                                  .
                                </div>
                                <div class="card-stats">
                                   
                                    <div class="card-stats-items ">
                                        <div class="container text-justify font-weight-bold">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                <form action="{{ route('cita.destroy', $citasssps->id ) }}" method="POST">
                                                    @csrf
                                                    @method('DELETE')
                                                    <input type="text"  value="{{$citasssps->useri_id}}"
                                                    name="useri_id" required="" hidden>
                                                        <button type="submit" class="btn btn-primary text-light" data-swal-confirmation>Cancelar</button>
                                                                                                 
                                                </form>
                                            </td> 
                                            </tr>
                                            @empty
                                                <h6 class="text-primary">Usted no tiene citas penientes.</h6>
                                            @endforelse
                                        </tbody>
                                    </table>
                                        </div>
                                ...
                                <div class="card-wrap">
                                    <div class="card-header">
                                        <p class="text-light font-weight-bold">. <br><span>.</span></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header bg-primary">
                                    <h6 class="text-light text-center fw-bold">Agenda de citas</h1>
                                </div>
                                <br>
                                
                                <div class="">
                                  <form method="post" action="{{route('cita.create')}}" class="needs-validation"
                                      novalidate="">
                                      @csrf
                                      <div class="card-body">
                                          <div class="row">
                                ...
                                <div class="">
                                  ...
                                  <div class="alert alert-warning text-dark text-center font-weight-bold col-md-11 container" role="alert">
                                    {{Session::get('warning')}}
                                  </div>
                                  @endif
                                    <form method="post" action="{{ route('cita.store') }}" class="needs-validation"
                                        novalidate="">
                                        @csrf
                                        <div class="card-body">
                                            <div class="row">
                                        ...
                                        <table class="table table-striped" id="myTable">
                                            ...
                                            <tbody>
                                                @forelse ($citas as $cita)
                                                    <tr>
                                                        <td>{{ $cita->id }}</td>
                                                        <td class="font-weight-600">{{ $cita->cliente->name }}</td>
